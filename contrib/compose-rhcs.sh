...
STAGING_DIR=staging/main-ubi9-minimal-latest-x86_64/
...
make_staging() {
  make BASEOS_REGISTRY=registry.redhat.io BASEOS_REPO=ubi9/ubi-minimal FLAVORS=main,ubi9-minimal,latest IMAGES_TO_BUILD=daemon-base || fatal "Cannot build rhel9"
}
