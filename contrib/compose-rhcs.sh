...
STAGING_DIR=staging/main-ubi8-minimal-latest-x86_64/
...
make_staging() {
  make BASEOS_REGISTRY=registry.redhat.io BASEOS_REPO=ubi8/ubi-minimal FLAVORS=main,ubi8-minimal,latest IMAGES_TO_BUILD=daemon-base || fatal "Cannot build rhel8"
}
